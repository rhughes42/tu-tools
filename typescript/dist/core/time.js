...
function estimateTime(path, options) {
    ...
    if (path.length < 2) {
        return {
            cuttingSeconds: 0,
            rapidSeconds: 0,
            spinupSeconds: Math.max(0, (_a = options.spinupSeconds) !== null && _a !== void 0 ? _a : 3),
            distance: 0,
            totalSeconds: Math.max(0, (_b = options.spinupSeconds) !== null && _b !== void 0 ? _b : 3),
        };
    }
    ...
    const spin = Math.max(0, (_c = options.spinupSeconds) !== null && _c !== void 0 ? _c : 3);
    return {
...
function runPerformanceBaseline(path, options, iterations = 5000) {
